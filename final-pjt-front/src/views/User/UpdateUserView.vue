  ...
  <div class="signup-container" v-if="store.user">
    ...
    <form class="signup-form" @submit.prevent="handleSubmit">
      ...
      <div v-show="showPasswordFields">
        ...
        <p>새로운 비밀번호</p>
        <div class="input-group-newpw input-group">
          <input type="password" class="input-field" placeholder="새로운 비밀번호를 입력하세요" v-model="pwFormData.new_password1"
            @blur="validatePassword(pwFormData.new_password1)">
          <p class="password-require" v-show="passwordChk">* 비밀번호는 대소 문자, 특수문자를 포함한 8자리 이상으로 설정해주세요</p>
        </div>
